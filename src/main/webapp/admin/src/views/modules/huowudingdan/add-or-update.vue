<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="物流单号" prop="wuliudanhao">
            <el-input v-model="ruleForm.wuliudanhao" 
                placeholder="物流单号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.wuliudanhao" label="物流单号" prop="wuliudanhao">
              <el-input v-model="ruleForm.wuliudanhao" 
                placeholder="物流单号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="货物名称" prop="huowumingcheng">
          <el-input v-model="ruleForm.huowumingcheng" 
              placeholder="货物名称" clearable  :readonly="ro.huowumingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="货物名称" prop="huowumingcheng">
              <el-input v-model="ruleForm.huowumingcheng" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="货物类型" prop="huowuleixing">
              <el-input v-model="ruleForm.huowuleixing" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="货物重量" prop="huowuzhongliang">
          <el-input v-model="ruleForm.huowuzhongliang" 
              placeholder="货物重量" clearable  :readonly="ro.huowuzhongliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="货物重量" prop="huowuzhongliang">
              <el-input v-model="ruleForm.huowuzhongliang" 
                placeholder="货物重量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="发货人" prop="fahuoren">
          <el-input v-model="ruleForm.fahuoren" 
              placeholder="发货人" clearable  :readonly="ro.fahuoren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="发货人" prop="fahuoren">
              <el-input v-model="ruleForm.fahuoren" 
                placeholder="发货人" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="发货地址" prop="fahuodizhi">
          <el-input v-model="ruleForm.fahuodizhi" 
              placeholder="发货地址" clearable  :readonly="ro.fahuodizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="发货地址" prop="fahuodizhi">
              <el-input v-model="ruleForm.fahuodizhi" 
                placeholder="发货地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="收货人" prop="shouhuoren">
          <el-input v-model="ruleForm.shouhuoren" 
              placeholder="收货人" clearable  :readonly="ro.shouhuoren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="收货人" prop="shouhuoren">
              <el-input v-model="ruleForm.shouhuoren" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="收货人手机" prop="shouhuorenshouji">
          <el-input v-model="ruleForm.shouhuorenshouji" 
              placeholder="收货人手机" clearable  :readonly="ro.shouhuorenshouji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="收货人手机" prop="shouhuorenshouji">
              <el-input v-model="ruleForm.shouhuorenshouji" 
                placeholder="收货人手机" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="发货状态" prop="fahuozhuangtai">
          <el-select :disabled="ro.fahuozhuangtai" v-model="ruleForm.fahuozhuangtai" placeholder="请选择发货状态">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="发货状态" prop="fahuozhuangtai">
	      <el-input v-model="ruleForm.fahuozhuangtai"
                placeholder="发货状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="订单备注" prop="dingdanbeizhu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="订单备注"
                  v-model="ruleForm.dingdanbeizhu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.dingdanbeizhu" label="订单备注" prop="dingdanbeizhu">
                    <span>{{ruleForm.dingdanbeizhu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	dengjishijian : false,
	dingdanbeizhu : false,
	fahuozhuangtai : false,
	userid : false,
      },
      ruleForm: {
        wuliudanhao: this.getUUID(),
        huowumingcheng: '',
        huowuleixing: '',
        huowuzhongliang: '',
        tupian: '',
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dingdanbeizhu = true;
          ...
          if(o=='fahuozhuangtai'){
            this.ruleForm.fahuozhuangtai = obj[o];
	    this.ro.fahuozhuangtai = true;
            continue;
          }
          if(o=='userid'){
       ...
       this.ruleForm.fahuozhuangtai='未发货'
      }
      // 获取用户信息
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.kehuzhanghao!=''&&json.kehuzhanghao){
                this.ruleForm.kehuzhanghao = json.kehuzhanghao
	    		this.ro.kehuzhanghao = true;
		}
		if(json.kehuxingming!=''&&json.kehuxingming){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `huowudingdan/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.huowudingdanCrossAddOrUpdateFlag = false;
						 this.parent.search();
