<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">物流管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			<!-- <div v-if="tableName=='kehu'" class="input-group">
			   <div class="label">客户账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.kehuzhanghao" class="input" type="text" placeholder="客户账号">
			   </div>
			 </div> -->
			<el-form-item label="客户账号" class="input" v-if="tableName=='kehu'">
			  <el-input v-model="ruleForm.kehuzhanghao" autocomplete="off" placeholder="客户账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='kehu'" class="input-group">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='kehu'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='kehu'">
			...
			<!-- <div v-if="tableName=='kehu'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.kehuxingming" class="input" type="text" placeholder="客户姓名">
			   </div>
			 </div> -->
			<el-form-item label="客户姓名" class="input" v-if="tableName=='kehu'">
			  <el-input v-model="ruleForm.kehuxingming" autocomplete="off" placeholder="客户姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='kehu'" class="input-group">
			   <div class="label">客户手机</div>
			   <div class="input-container">
			     <input v-model="ruleForm.kehushouji" class="input" type="text" placeholder="客户手机">
			   </div>
			 </div> -->
			<el-form-item label="客户手机" class="input" v-if="tableName=='kehu'">
			  <el-input v-model="ruleForm.kehushouji" autocomplete="off" placeholder="客户手机"  />
			</el-form-item>
			...
			<el-form-item label="部门" class="input" v-if="tableName=='yuangong'">
			  <el-input v-model="ruleForm.bumen" autocomplete="off" placeholder="部门"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yuangong'" class="input-group">
			...
			<el-form-item label="职位" class="input" v-if="tableName=='yuangong'">
			...
			<el-form-item label="联系方式" class="input" v-if="tableName=='yuangong'">
