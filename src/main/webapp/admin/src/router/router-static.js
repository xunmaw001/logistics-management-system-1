...
import center from '@/views/center'
    ...
    import huowuqingkuang from '@/views/modules/huowuqingkuang/list'
    ...
    import liuyanhuifu from '@/views/modules/liuyanhuifu/list'
    import config from '@/views/modules/config/list'
    import huowudingdan from '@/views/modules/huowudingdan/list'
